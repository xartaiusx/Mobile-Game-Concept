...
Imported KayKit screenshots and URL shortcuts are quarantined under `Assets/ThirdParty/_Documentation`.

Phase 9.11 adds an inactive archive for imported assets that are useful to keep nearby but must not be referenced by active scenes, prefabs, controllers, or ScriptableObjects:

- Archive root: `Assets/ThirdParty/_Archive`
